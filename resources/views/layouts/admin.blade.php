...
<div class="wrapper">
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
        ...
        <a href="/" class="brand-link">
            <img src="{{ asset('uploads/images/defaultpet.png') }}" alt="Admin Logo" class="brand-image img-circle elevation-3"
                 style="opacity: .8">
...
{{--                            </li>--}}
    ...
    <footer class="main-footer">
        <strong>Copyright &copy; 2014-2019 petshop.com.</strong>
        All rights reserved.
