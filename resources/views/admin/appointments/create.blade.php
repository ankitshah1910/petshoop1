                    ...
                    <div class="card-body">
                        <form method="POST" action="{{isset($appointments)?route('admin.appointments.update', $appointments):route('admin.appointments.store')}}">
                            ...
                            <div class="form-group">
                                ...
                                <select name="pet_id" class="form-control" id="client_id" required>
                                    @foreach($pets as $pet)
                            ...
                            <div class="form-group">
                                ...
                                <input type="datetime-local" name="appointment_time" class="form-control" value="{{isset($appointments)?$appointments->appointment_time:''}}" required/>
                            </div>

                            <div class="form-group">
                                <label for="description">Special Note/Description</label>
                                <textarea type="text" name="description" class="form-control" required>{{isset($appointments)?$appointments->description:''}}</textarea>
                            </div>
